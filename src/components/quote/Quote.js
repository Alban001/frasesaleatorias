...
const Quote = () => {
  ...
  return (
    ...
    <div className='quote' id="quote-box">
          <div className="quote__container-content" id="text" >
          <div id="author">
            ...
            <div className="quote__button-container">
              <div className="quote__button-left">
                  <div className="quote__button">
                        <a id="tweet-quote" href="twitter.com/intent/tweet" target='_top'><i className="fa-brands fa-square-twitter"></i></a>
                  </div>
                  <div className="quote__button">
                        <a href="https://www.tumblr.com/" target='_blank'><i className="fa-brands fa-tumblr"></i></a>
                  </div> 
                </div>
               <div className="quote__button-right" id="new-quote">
